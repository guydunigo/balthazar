...
fn new_manager_creator(podes_rc: Arc<Mutex<Vec<Option<manager::Manager>>>>, listener_rx: mpsc::Receiver<TcpStream>, man_tx: mpsc::Sender<manager::Message>) -> thread::JoinHandle<Result<(), Error>> {
